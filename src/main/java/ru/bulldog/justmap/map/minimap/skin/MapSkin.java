...
public class MapSkin extends Image {	
	...
	private void registerPavedTexture(int w, int h) {
		...
		this.textureId = new ResourceLocation(JustMap.MODID, String.format(pattern, this.id, w, h, border));
	...
	public String toString() {
		return this.getName().getContents();
	}
	...
	static {
		addSquareSkin("Minecraft Map", new ResourceLocation(JustMap.MODID, "textures/skin/skin_def_map.png"), 64, 64, 5, false, true);
		addSquareSkin("Minecraft LaF", new ResourceLocation(JustMap.MODID, "textures/skin/skin_gui_laf.png"), 64, 64, 3, false, true);
		addSquareSkin("Minecraft Gui", new ResourceLocation(JustMap.MODID, "textures/skin/skin_def_gui.png"), 64, 64, 5, true);
		addSquareSkin("Minecraft Gui Fancy", new ResourceLocation(JustMap.MODID, "textures/skin/skin_def_gui_fancy.png"), 64, 64, 7, true);
		addSquareSkin("Metal Frame", new ResourceLocation(JustMap.MODID, "textures/skin/skin_simple_metal.png"), 64, 64, 4, true);
		addSquareSkin("Oak Frame", new ResourceLocation(JustMap.MODID, "textures/skin/skin_oak.png"), 64, 64, 10, false, true);
		addSquareSkin("Bamboo Frame", new ResourceLocation(JustMap.MODID, "textures/skin/skin_bamboo.png"), 64, 64, 9, false, true);
		addRoundSkin("Minecraft Gui", new ResourceLocation(JustMap.MODID, "textures/skin/skin_def_gui_round.png"), 256, 256, 10);
		addRoundSkin("Frame Round", new ResourceLocation(JustMap.MODID, "textures/skin/skin_frame_round.png"), 256, 256, 12);
		addRoundSkin("Frame Runed", new ResourceLocation(JustMap.MODID, "textures/skin/skin_runed_round.png"), 256, 256, 19);
		addRoundSkin("Frame Frozen", new ResourceLocation(JustMap.MODID, "textures/skin/skin_frozen_round.png"), 256, 273, 17);
