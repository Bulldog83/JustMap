...
public class WaypointIcon extends MapIcon<WaypointIcon> {
	...
	public void draw(PoseStack matrices, VertexConsumerProvider consumerProvider, int mapX, int mapY, int mapW, int mapH, double offX, double offY, double rotation) {
