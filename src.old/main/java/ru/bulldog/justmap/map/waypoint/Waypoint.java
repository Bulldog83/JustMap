...
public class Waypoint {
	...
	public static Waypoint fromJson(JsonObject jsonObject) {
		...
		if (jsonObject.has("dimension")) {
			try {
				...
				ResourceLocation dimension = new ResourceLocation(JsonHelper.getString(jsonObject, "dimension", "unknown"));
	...
	public static class Icon extends Image {
		...
		private Icon(int key, ResourceLocation icon, NativeImage texture, int color, int w, int h) {
			super(icon, texture);
			this.key = key;
			this.color = color;
		}
