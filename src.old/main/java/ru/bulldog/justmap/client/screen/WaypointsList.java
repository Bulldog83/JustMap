...
public class WaypointsList extends MapScreen {
	...
	protected void init() {
		...
		this.prevDimensionButton = new ButtonWidget(x + 10, 6, 20, 20, new TextComponent("<"), (b) -> cycleDimension(-1));
		this.nextDimensionButton = new ButtonWidget(x + screenWidth - 30, 6, 20, 20, new TextComponent(">"), (b) -> cycleDimension(1));		
