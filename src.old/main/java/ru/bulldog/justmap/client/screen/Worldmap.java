...
public class Worldmap extends MapScreen implements IMap {
	...
	private void addMapButtons() {
		this.addButton(new ButtonWidget(width - 24, 10, 20, 20, new TextComponent("x"), (b) -> onClose()));		
		this.addButton(new ButtonWidget(width / 2 - 10, height - paddingBottom - 44, 20, 20, new TextComponent("\u2191"), (b) -> moveMap(Direction.NORTH)));
		this.addButton(new ButtonWidget(width / 2 - 10, height - paddingBottom - 22, 20, 20, new TextComponent("\u2193"), (b) -> moveMap(Direction.SOUTH)));
		this.addButton(new ButtonWidget(width / 2 - 32, height - paddingBottom - 32, 20, 20, new TextComponent("\u2190"), (b) -> moveMap(Direction.WEST)));
		this.addButton(new ButtonWidget(width / 2 + 12, height - paddingBottom - 32, 20, 20, new TextComponent("\u2192"), (b) -> moveMap(Direction.EAST)));		
		this.addButton(new ButtonWidget(width - 24, height / 2 - 21, 20, 20, new TextComponent("+"), (b) -> changeScale(-0.25F)));
		this.addButton(new ButtonWidget(width - 24, height / 2 + 1, 20, 20, new TextComponent("-"), (b) -> changeScale(+0.25F)));		
		this.addButton(new ButtonWidget(width - 24, height - paddingBottom - 22, 20, 20, new TextComponent("\u271C"), (b) -> setCenterByPlayer()));
		this.addButton(new ButtonWidget(4, paddingTop + 2, 20, 20, new TextComponent("\u2630"), (b) -> mapMenu.toggleVisible()));
		this.addButton(new ButtonWidget(4, height - paddingBottom - 22, 20, 20, new TextComponent("\u2726"), (b) -> client.openScreen(new WaypointsList(this))));
	}
	...
	public void renderForeground(PoseStack matrices) {
		...
		drawCenteredString(matrices, client.font, cursorCoords, width / 2, paddingTop + 4, Colors.WHITE);
	}
