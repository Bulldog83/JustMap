...
public abstract class ClientPlayNetworkHandlerMixin {
	...
	public void onConnect(Minecraft client, Screen screen, ClientConnection connection, GameProfile profile, CallbackInfo cinfo) {
		WorldManager.load();
	}
	...
	public void onPlayerSpawnPosition(PlayerSpawnPositionS2CPacket packet, CallbackInfo cinfo) {
		JustMap.LOGGER.debug("Level spawn position set to {}", packet.getPos().toShortString());
